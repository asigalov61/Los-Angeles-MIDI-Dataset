...
Original file is located at
    https://colab.research.google.com/drive/1Res4_QjWXP9-8EMNT9iwxFWC_sd-2Zk_

# Master MIDI Dataset GPU Search and Filter (ver. 1.0)
...
number_of_top_ratios_MIDIs_to_collect = 20 #@param {type:"slider", min:5, max:50, step:1}
...
if filez:
  ...
  for f in filez:
    try:
          ...
          filter_size = number_of_top_ratios_MIDIs_to_collect
